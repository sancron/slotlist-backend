...
For a Git-based deployment via Portainer – including guidance on how to keep the backend network isolated so that reverse proxies such as Nginx Proxy Manager can join it later – see [docs/PortainerDeployment.md](docs/PortainerDeployment.md).
